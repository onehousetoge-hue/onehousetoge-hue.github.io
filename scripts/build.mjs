...
const resourcesBody = `${pageHero({ eyebrow: "주거상생 자료", title: "가족과 이야기할 때,<br>함께 생활할 때 꺼내 보세요.", description: "먼저 이해하는 안내글 2편과 직접 적어보는 생활자료 6종을 골라 읽어 보세요. 작성한 메모는 자동 저장되거나 전송되지 않습니다.", meta: updatedMeta("/resources/") })}<section class="section"><div class="container"><nav class="section-jumps resource-navigation" aria-label="자료 유형 선택"><a href="#find-guide">내 상황에 맞는 자료 찾기</a><a href="#homesharing-articles">먼저 이해하기 · 안내글 2편</a><a href="#worksheets">직접 작성하기 · 자료 6종</a><a href="#youth-housing">청년·유학생 안내</a></nav>${guideFinder()}${homesharingCards()}<h2 id="worksheets">직접 작성하는 생활자료 6종</h2><p>화면에서 메모하거나 체크하고, 필요한 내용은 인쇄할 수 있습니다. 회원가입이나 상담 신청 없이 이용하세요.</p><div class="resource-grid">${resourceCards(resources, 3)}</div>${youthGuides()}</div></section>`;
