...
export function landingPage(programCards) {
  ...
  <section class="section section-dark"><div class="container"><div class="section-header"><div><p class="eyebrow">상담 이용방법</p><h2>궁금한 내용을<br>편하게 말씀해 주세요.</h2></div><p>전화·이메일 또는 간단한 홈페이지 문의로 상담을 시작할 수 있습니다. 편한 방법을 선택해 주세요.</p></div><ol class="steps consultation-steps"><li><span>1</span><h3>편한 방법으로<br>문의합니다.</h3><p>궁금한 점과 필요한 안내를 간단히 알려주세요.</p></li><li><span>2</span><h3>대표 또는 운영진이<br>내용을 확인합니다.</h3><p>안내 가능한 범위를 설명하고 함께 확인할 사항을 정리합니다.</p></li><li><span>3</span><h3>필요한 자료와<br>다음 확인처를 안내합니다.</h3><p>전문 판단이 필요한 내용은 관련 공공기관이나 전문가에게 확인할 수 있도록 안내합니다.</p></li></ol><p class="scope-note">세금·법률·계약에 대한 확정적인 판단, 주택 안전 진단, 공사·중개·입주 연결은 제공하지 않습니다.</p></div></section>
<section class="section"><div class="container organization-intro"><div><p class="eyebrow">한지붕 소개</p><h2>남는 공간을 살피고,<br>세대가 함께 살아갈 기준을 만듭니다.</h2></div><div><p>한지붕은 어르신의 유휴공간과 청년 주거 문제를 함께 살피고, 세대가 함께 살아가기 위한 정보를 나누는 세법상 비영리법인입니다.</p><p>대표 ${site.representative} · 고유번호 ${site.registrationNumber}</p><a class="text-link" href="/transparency/">단체 운영정보 확인하기${icon("arrow")}</a><p>노원구청 마을공동체 사업 지원금 600,000원의 계획과 실제 사용 내역을 공개합니다. 2026년 9월 20일 기준 집행액은 191,500원, 미집행액은 408,500원입니다. <a href="/activities/nowon-grant-execution/">지원금 계획·집행 현황 보기</a></p><p><a href="/privacy/">개인정보 처리방침</a></p></div></div></section>
  <section class="final-cta"><div class="container"><p class="eyebrow">전화·이메일 무료상담</p><h2>혼자 결정하기 전에,<br>궁금한 점부터 이야기해 주세요.</h2><div class="hero-actions"><a class="button" href="/consultation/">홈페이지에서 상담 문의</a><a class="button button-secondary" href="${site.phoneHref}">${icon("phone")}전화로 문의하기</a><a class="button button-secondary" href="${site.emailHref}">${icon("mail")}이메일로 문의하기</a></div><p class="contact-readable"><a href="${site.phoneHref}">${site.phone}</a><span aria-hidden="true"> · </span><a href="${site.emailHref}">${site.email}</a></p><a class="text-link" href="/partnership/">교육·봉사 기관협력 문의${icon("arrow")}</a></div></section>`;
}
