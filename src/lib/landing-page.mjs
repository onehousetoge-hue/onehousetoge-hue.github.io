...
<section class="section"><div class="container organization-intro"><div><p class="eyebrow">한지붕 소개</p><h2>남는 공간을 살피고,<br>세대가 함께 살아갈 기준을 만듭니다.</h2></div><div><p>한지붕은 어르신의 유휴공간과 청년 주거 문제를 함께 살피고, 세대가 함께 살아가기 위한 정보를 나누는 세법상 비영리법인입니다.</p><p>대표 ${site.representative} · 고유번호 ${site.registrationNumber}</p><a class="text-link" href="/transparency/">단체 운영정보 확인하기${icon("arrow")}</a><p>노원구청 마을공동체 사업 지원금 600,000원의 사용 계획을 공개합니다. 집행 예정액은 400,000원, 추후 사업비는 200,000원입니다. <a href="/activities/nowon-grant-execution/">지원금 사용 계획 보기</a></p><p><a href="/privacy/">개인정보 처리방침</a></p></div></div></section>
