...
export function fieldRecordPage() {
  ...
  <section class="section field-story"><div class="container">
    <div class="field-context"><h2>함께한 사람들의 현장 기록</h2><p>한지붕의 교육 활동과, 같은 구성원이 홈투게더 등의 이름으로 참여한 현장 경험을 함께 소개합니다. 사진 속 기존 명칭과 안내물은 당시의 활동 맥락을 보여줍니다.</p></div>
    ...
    <section class="field-chapter" id="community-exchange" aria-labelledby="community-title"><div class="field-chapter-heading"><div><p class="eyebrow">02 · 구성원의 관련 현장 경험</p><h2 id="community-title">지역행사에서 나눈<br>주거와 생활 이야기</h2></div><p>공릉1동 지역행사에서 주민을 만난 사진입니다. 같은 구성원들이 홈투게더 안내 부스에 참여한 현장으로, 자료를 펼치고 주민과 대화하는 모습을 담았습니다.</p></div><div class="field-photo-pair">${figure(record.photos[2])}${figure(record.photos[3])}</div><p class="field-caption-note">사진에 보이는 기관 로고는 당시 현장 안내물입니다. 로고의 노출이 해당 기관과 한지붕의 공식 협약·후원 관계를 뜻하지는 않습니다.</p></section>
