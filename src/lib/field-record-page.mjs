...
export function fieldRecordPage() {
  const body = pageHero({
    ...
    '<div class="contact-strip"><div><h2>빈방 활용과 공동생활이 궁금하신가요?</h2><p>일반 상담은 전화·이메일로 문의하고, 기관·경로당 상담은 사전 협의해 주세요.</p></div><div class="contact-actions"><a class="button" href="/contact/">무료상담 신청 문의</a><a class="button button-secondary" href="/programs/senior-home-consulting/">상담 가능한 내용 확인하기</a><a class="button button-secondary" href="/participate/#partnership">기관·경로당 상담 요청하기</a></div></div>' + evidenceFlow() + '</div></section>';
  return layout({
