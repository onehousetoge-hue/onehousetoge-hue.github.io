...
export function fieldRecordPage() {
  const body = pageHero({
    ...
    serviceScope() + '<div class="field-context"><h2>현장의 질문을 상담자료로 이어갑니다</h2><p>한지붕은 노원구 지역 어르신과 가족을 대상으로 주거공간 활용, 공동생활 준비, 생활규칙과 복지정보에 관한 무료상담을 진행합니다. 반복되는 질문과 어려움을 기록해 상담자료와 지역 주거복지 프로그램에 반영합니다.</p><p>아래는 운영진이 제공한 회차별 활동 기록입니다. 일반 문의는 전화·이메일로, 기관·경로당 상담 요청은 사전 협의로 안내합니다.</p></div>' +
