...
export function fieldRecordFeature() {
  return `<section class="section field-feature-section"><div class="container field-feature"><figure class="field-feature-photo">${photo(record.photos[0])}<figcaption>시니어 디지털 교육 현장 · 한지붕 제공</figcaption></figure><div class="field-feature-copy"><p class="eyebrow">사진으로 만나는 활동과 사람들</p><h2>시니어가 있는 현장에서,<br>지역사회와 함께합니다.</h2><p>같은 화면을 보며 배우는 시간부터<br>주민과 마주 앉아 이야기를 나누는 자리까지.<br>한지붕 구성원들이 함께한 교육과 현장 경험을 전합니다.</p><ul class="field-tags"><li>디지털 교육</li><li>지역사회 교류</li><li>주거모델 논의</li></ul><a class="button" href="/activities/senior-digital-education/">디지털 교육 경험 보기${icon("arrow")}</a><p><a class="text-link" href="${record.href}">전체 현장 사진 보기${icon("arrow")}</a></p></div></div></section>`;
}
...
export function fieldRecordPage() {
  ...
  <section class="section field-story"><div class="container">
    <div class="field-context"><h2>함께한 사람들의 현장 기록</h2><p>한지붕 구성원들이 함께한 교육과 지역사회 현장 경험을 소개합니다. 사진 속 안내물은 당시의 활동 맥락을 보여줍니다.</p></div>
    ...
    <section class="field-chapter" id="digital-education" aria-labelledby="digital-title"><div class="field-chapter-heading"><div><p class="eyebrow">01 · 구성원의 디지털 교육 경험</p><h2 id="digital-title">같은 화면을 보며,<br>함께 배우는 디지털 생활</h2></div><p>노원구 시니어 디지털 교육 현장입니다. 어르신이 직접 휴대전화를 사용하고, 청년이 옆에서 화면을 짚으며 사용 방법을 함께 살펴봅니다.</p></div><div class="field-photo-pair field-photo-pair-education">${figure(record.photos[0])}${figure(record.photos[1])}</div><p class="field-chapter-link"><a class="text-link" href="/activities/senior-digital-education/">디지털 교육 경험 읽기${icon("arrow")}</a></p></section>
    ...
    <aside class="field-record-note" aria-labelledby="photo-record-info"><h2 id="photo-record-info">사진 기록 안내</h2><p>운영자가 제공하고 공개 동의를 확인한 사진입니다. 개별 사진에 확인되지 않은 활동일이나 기관명을 붙이지 않았습니다. 게시일은 이 기록을 홈페이지에 정리한 날짜로, 실제 활동일을 뜻하지 않습니다. 별도 집계가 없는 참여 인원이나 교육 효과는 기재하지 않았습니다.</p></aside>
