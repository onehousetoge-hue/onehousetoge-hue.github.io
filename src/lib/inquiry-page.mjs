...
export function inquiryPage(kind) {
  ...
  `<section class="section"><div class="container narrow"><div class="notice"><h2>필요한 내용만 간단히 알려 주세요</h2><p>초기 상담에는 주민등록번호, 상세주소, 계약서, 금융정보 등 민감정보를 보내실 필요가 없습니다. 다른 사람의 연락처나 건강정보도 적지 마세요.</p><p>${partner ? '문의만으로 일정이나 협력이 확정되지는 않습니다.' : '기초상담은 무료입니다. 집수리·입주 알선·계약대행·법률·세무 자문은 제공하지 않습니다.'}</p></div>
