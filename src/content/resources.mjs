...
const commonMeta = {
  ...
  updatedAt: "2026-09-23", updatedLabel: "2026년 9월 23일",
...
const items = [
  {
    slug: "family-checklist", category: "가족 대화", title: "빈방 활용, 가족회의에서 먼저 나눌 질문",
    description: "당사자의 생각부터 듣고, 합의한 내용과 아직 결정하지 않을 내용을 나누는 인쇄용 가족회의 질문지입니다.",
    outcome: "회의 뒤 ‘합의한 것·보류한 것·다시 확인할 것’을 한 장에 남깁니다.", readTime: "읽기 4분 · 작성은 각자의 속도로",
  ...
  {
    slug: "shared-living-rules", category: "생활규칙", title: "함께 쓰는 생활규칙 작성표",
    description: "생활시간·방문객·청소·비용 기준을 직접 적고, 예외와 재논의 시점까지 정리하는 빈 워크시트입니다.",
    outcome: "막연한 부탁을 ‘누가·언제·무엇을’ 하는지 알 수 있는 생활 약속으로 바꿉니다.", readTime: "읽기 3분 · 함께 작성",
  ...
  {
    slug: "consultation-preparation", category: "상담 준비", title: "무료상담 전, 질문 세 가지부터 정리하세요",
    description: "초기 문의에 필요한 정보, 보내지 않아도 되는 개인정보, 상담 후 확인할 질문을 나눠 준비합니다.",
    outcome: "민감서류 없이도 상담 목적을 설명하고, 상담 뒤 스스로 확인할 목록을 남깁니다.", readTime: "읽기 3분 · 질문 정리",
  ...
  {
    slug: "private-common-space", category: "공간 구분", title: "개인공간과 공용공간, 경계부터 정하기",
    description: "설명용 공간 도식과 사용기준표로 출입·보관·사용 후 정리 기준을 구분합니다.",
    outcome: "공간마다 ‘누가 사용할 수 있는지·먼저 물어볼 것·사용 후 할 일’을 정합니다.", readTime: "읽기 4분 · 공간 기준 작성",
  ...
  {
    slug: "conflict-prevention", category: "갈등 예방", title: "불편한 마음을 생활 요청으로 바꾸는 대화",
    description: "교육용 대화 예문을 바탕으로 관찰한 사실·불편·요청을 나누고 외부 도움이 필요한 상황을 구분합니다.",
    outcome: "상대를 평가하는 말 대신 바라는 행동을 설명하는 문장을 만들어 봅니다.", readTime: "읽기 4분 · 대화 연습",
  ...
  {
    slug: "korean-housing-culture", category: "주거문화 안내", title: "한국의 주거생활, 용어와 도움받을 곳",
    description: "낯선 주거 용어를 쉬운 말로 이해하고, 계약·주거지원·외국인 생활 질문에 맞는 공식 창구를 찾습니다.",
    outcome: "생활 약속과 제도상 확인할 문제를 구분하고 필요한 기관에 질문할 수 있습니다.", readTime: "읽기 4분 · 문의처 찾기",
