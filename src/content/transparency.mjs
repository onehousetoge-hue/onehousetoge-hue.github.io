...
export const transparencyBody = `${pageHero({ eyebrow: "운영·투명성", title: "지원금의 쓰임과<br>단체 운영을 공개합니다.", description: "노원구청 마을공동체 사업 지원금의 수령액과 사용 계획, 단체 등록정보와 운영·회계 원칙을 확인할 수 있습니다.", meta: '<div class="page-meta"><span>마지막 수정일 2026.09.24</span></div>' })}
...
<h2>재정정보의 공개 범위</h2><p>현재 공개한 내용은 노원구청 마을공동체 사업 지원금의 수령액과 집행 계획입니다. 설립 당시 별도 보유재산이 없었으며, 현재 등록상 수익사업은 없습니다. 마을공동체 사업 지원금 수령과 수익사업 여부는 서로 다른 정보입니다.</p><p>단체 전체의 연간 결산은 이 지원금 내역과 구분합니다. 확인된 결산자료와 공개 범위가 마련되면 집계 기간과 기준일을 함께 안내합니다.</p>
...
<aside class="side-nav"><h2>바로 확인하기</h2><a href="#funding">지원금 사용 계획</a><a href="#organization">단체 등록정보</a><a href="#accounting">운영·회계 원칙</a><a href="/activities/nowon-grant-execution/">집행 계획 세부항목 5건</a><a href="/activities/nonprofit-registration/">고유번호 발급 기록</a><a href="/privacy/">개인정보 처리방침</a><a href="/contact/">공개자료 문의</a></aside></div></section>`;
