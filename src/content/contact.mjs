...
<section class="section"><div class="container">
  ...
  <section class="prose"><h2>지금 이용할 수 있는 상담</h2><p>전화·이메일 기초상담은 무료이며 예약비나 상담료를 받지 않습니다. 가족과의 대화, 공간 사용기준, 공동생활 준비에 관한 일반 정보를 안내합니다. 현재 주택 방문상담·집수리·안전진단·부동산 중개·법률·세무 자문은 제공하지 않습니다.</p><p><a href="/resources/consultation-preparation/">무료상담 준비 질문지</a>를 먼저 살펴보셔도 좋습니다.</p><h2>기관 프로그램은 사전 협의로 진행합니다</h2><p>기관명, 대상, 희망 주제와 일정 범위를 알려 주세요. 운영진과 기관이 날짜·장소·역할을 함께 정합니다. 강사·공간·재료 등 비용이 필요한 항목은 금액과 부담 주체를 이메일로 확인하고 합의한 뒤 진행하며, 합의하지 않은 비용을 청구하지 않습니다.</p><p>개인 봉사 참여에는 가입비가 없습니다. 확정된 활동과 필요한 역할에 맞춰 참여 가능 여부를 안내합니다.</p></section>
</div></section>`;
